        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-6xl md:text-7xl font-bold text-balance">
              <span className="text-foreground">Harness the Power of </span>
              <span className="text-primary">Artificial Intelligence</span>
            </h1>

            <p className="text-xl text-muted-foreground max-w-2xl">
              Leverage cutting-edge AI and machine learning technologies to automate processes, gain competitive
