        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full">
              ...
              <span className="text-sm text-foreground">IT Support Services</span>
            </div>

            <h1 className="text-6xl md:text-7xl font-bold text-balance">
              <span className="text-foreground">Keep Your Systems </span>
              <span className="text-primary">Running Smoothly</span>
            </h1>

            <p className="text-xl text-muted-foreground max-w-2xl">
              Comprehensive IT support services that ensure minimal downtime, maximum productivity, and reliable
            ...
            <div className="flex gap-4 pt-6">
              ...
              <Button
                ...
                onClick={() =>
                  window.open("https://wa.me/919986639994?text=I%20am%20interested%20in%20IT%20Support%20services")
                }
              >
                Contact Us Today
              </Button>
            ...
            >
              <div className="w-full h-full bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center">
                <motion.div animate={{ y: [0, -20, 0] }} transition={{ duration: 4, repeat: Number.POSITIVE_INFINITY }}>
                  <Headphones className="w-48 h-48 text-primary/20" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
