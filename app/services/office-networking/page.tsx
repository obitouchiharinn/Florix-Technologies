...
import { Network, Shield, Wifi, Users, Zap, Lock } from "lucide-react"
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full">
              ...
              <span className="text-sm text-foreground">Office Networking</span>
            </div>

            <h1 className="text-6xl md:text-7xl font-bold text-balance">
              <span className="text-foreground">Reliable Network </span>
              <span className="text-primary">Infrastructure</span>
            </h1>

            <p className="text-xl text-muted-foreground max-w-2xl">
              Design, implement, and maintain secure office networks that connect your team seamlessly and keep your
              business connected.
            </p>
            ...
            <div className="flex gap-4 pt-6">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/919986639994?text=I%20am%20interested%20in%20Office%20Networking%20services",
                  )
                }
              >
                Contact Us Today
            ...
            >
              <div className="w-full h-full bg-gradient-to-br from-cyan-100 to-blue-100 flex items-center justify-center">
                <motion.div animate={{ y: [0, -20, 0] }} transition={{ duration: 4, repeat: Number.POSITIVE_INFINITY }}>
                  <Network className="w-48 h-48 text-primary/20" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
